...
namespace NIUI
{
	...
	// NIUI Conversion constants.
	const float UNREAL_ROT_CONVERSION = 32768.0f;
	const float RAD_TO_UNREAL = UNREAL_ROT_CONVERSION / PI;
	const float DEGREE_TO_UNREAL = UNREAL_ROT_CONVERSION / 180.0f;
	const float UNREAL_TO_RAD = PI / UNREAL_ROT_CONVERSION;
	const float UNREAL_TO_DEG = 180.0f / UNREAL_ROT_CONVERSION;
