...
namespace NIUI
{
	...
	public:
		...
		NIUI_STATUS Initilise(const char* xmlpath, int maxUsers);
		...
		bool GetJointLocation(int userID, int joint, UDKVector3* vec);
		bool GetLocalJointLocation(int userID, int joint, UDKVector3* vec);
		bool GetUserCentre(int userID, UDKVector3* vec);
		bool GetBoneAxes(int userID, int joint, UDKVector3* forward, UDKVector3* side, UDKVector3* up);
	};
